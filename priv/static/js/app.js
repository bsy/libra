...
window.onload = function () {
  ...
  if (document.getElementById("page")) {
    new _page2.default(pageContainer);
  }
};
...
;require.register("web/static/js/page.js", function(exports, require, module) {
"use strict";
...
var Page = function () {
  ...
  _createClass(Page, [{
    key: "joinPageChannel",
    value: function joinPageChannel() {
      var _this = this;

      var channel = _socket2.default.channel("page:" + this.pageId);

      channel.on("page-update", function (payload) {
        _this.updateResults(payload);
      });
    ...
    key: "updateResults",
    value: function updateResults(payload) {
